.. funkyheatmappy documentation master file, created by
   sphinx-quickstart on Mon Nov  4 17:37:19 2024.
...
which allows assigning multiple palettes or geometries or grouping rows and columns 
together in categories.

This package is a Python-based implementation of the `{funkyheatmap} <https://github.com/funkyheatmap/funkyheatmap>`_ package.
...
Contributing
------------
Do not hesitate to open an issue or a pull request if you have any suggestions or if you find any bugs.
